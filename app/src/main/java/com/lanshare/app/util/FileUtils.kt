...
import com.lanshare.app.model.getFileType
import java.io.File
...
object FileUtils {
    ...
    fun getReceiveDirectory(context: Context): File {
        ...
        val dir = File(context.getExternalFilesDir(null), "LanShare")
            ...
            while (cursor.moveToNext() && images.size < limit) {
                ...
                images.add(
                    MediaFile(
                        ...
                        fileType = com.lanshare.app.model.FileType.IMAGE
                    )
                )
            }
        }
...
data class MediaFile(
    ...
    val size: Long,
    val dateAdded: Long,
    val fileType: com.lanshare.app.model.FileType
)
